...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin-top:4.5%;">
...
<section>
  <div class="container">
    <div class="row" style=" margin-left: -30%; padding-top: 30px;">
    <!--   <div class="col-lg-12"> -->
    <div class="card" style=" width:2000px; height:500px; border: 1px solid red;">
...
<div class="card" style="width:300px; height:200px;">
  <img class="card-img-top" src="Adobe.png" style="height: 30%;" alt="Card image cap">
  <div class="card-body">
...
<div class="col-lg-3">
<div class="card" style="width:300px; height:200px;">
  <img class="card-img-top" src="Explore.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
